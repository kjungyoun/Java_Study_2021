...
public class Book implements Cloneable{
	...
	private String desc       ;
	public Book() {
		this("11","ssafy", "ssafy", "멀캠", 1000, "파이팅");
	}
	public Book(String isbn, String title, String author, String publisher, int price, String desc) {		//반드시 인자를 받아서 생성하는 것이 아니면 생성하는 것이 좋다.
